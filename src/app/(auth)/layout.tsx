    ...
    <div className="grid min-h-svh flex-1 lg:grid-cols-2">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(60% 55% at 65% 30%, oklch(0.4 0.2 292 / 55%), transparent 70%), radial-gradient(45% 40% at 25% 70%, oklch(0.35 0.16 320 / 35%), transparent 70%)",
          }}
        />
        {/* Conic accents */}
        <div
          ...
          style={{
            backgroundImage:
              "conic-gradient(from 210deg at 70% 25%, transparent 0deg, oklch(0.5 0.22 290 / 30%) 60deg, transparent 130deg, oklch(0.55 0.2 340 / 18%) 220deg, transparent 300deg)",
          }}
        />
        {/* Star field */}
        ...
        <div className="relative p-12 pb-14">
          ...
          <p
            ...
            style={{ color: "oklch(0.75 0.02 290)" }}
          >
